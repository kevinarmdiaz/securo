...
export const navItems: NavItem[] = [
  ...
  { type: 'link', key: 'financialHub', path: '/hub', icon: LayoutDashboard, module: 'goals' },
  { type: 'link', key: 'payday', path: '/payday', icon: CalendarCheck, module: 'goals' },
  { type: 'link', key: 'loans', path: '/loans', icon: Calculator, module: 'goals' },
  { type: 'link', key: 'debtBattle', path: '/loans/battle', icon: Swords, module: 'goals' },
  { type: 'link', key: 'refinance', path: '/loans/refinance', icon: ArrowRightLeft, module: 'goals' },
  { type: 'link', key: 'interestRates', path: '/interest-rates', icon: Percent, module: 'goals' },
